...
overlap3 = is_overlapping((950, 1430), [])
# overlap4 = is_overlapping((1726, 2450), [2885, 3793])
print("Overlap 1 = ", overlap1)
print("Overlap 2 = ", overlap2)
print("Overlap 3 = ", overlap3)
# print("Overlap 4 = ", overlap4)
...
def insert_audio_clip(background, audio_clip, previous_segments):
    ...
    # print('previous_segments',previous_segments)
    ...
    # previous_segments += segment_time
...
def insert_ones(y, segment_end_ms):
    ...
    # If the "activate" ended at time step  tt , then set  y⟨t+1⟩=1  as well as for up to 49(???) additional consecutive values
...
def create_training_example(background, activates, negatives):
    ...
    # global Ty = 1375 # The number of time steps in the output of our model
    y = np.zeros((1, Ty))
    ...
    # print('random_activates', random_activates)
    k = 0

    
    ### START CODE HERE ### (≈ 3 lines)
    # Step 3: Loop over randomly selected "activate" clips and insert in background
    # Randomly select 0 to 4 "activate" audio clips, and insert them onto the 10sec clip. 
    # Also insert labels at the correct position in the label vector  yy 
    ...
    for random_negative in random_negatives:
        # 2. Insert the audio clip on the background 
